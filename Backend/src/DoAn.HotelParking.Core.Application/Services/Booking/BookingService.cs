...
public class BookingService : IBookingService
{
    ...
    public async Task<BookingDto?> UpdateAsync(int id, UpdateBookingDto dto, CancellationToken cancellationToken = default)
    {
        ...
        var desiredStatus = (BookingStatus)dto.Status;
        booking.Status = desiredStatus == BookingStatus.Pending
        ...
        CancellationToken cancellationToken)
    {
        ...
        var finalStatus = allowAutoConfirm && paidAmount >= totalAmount
            ? BookingStatus.Confirmed
