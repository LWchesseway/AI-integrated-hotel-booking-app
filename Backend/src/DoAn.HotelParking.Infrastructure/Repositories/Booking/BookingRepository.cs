...
public class BookingRepository : GenericRepository<DoAn.HotelParking.Core.Domain.Entities.Booking.Booking>, IBookingRepository
{
    ...
    public Task<bool> HasOverlappingBookingByHotelAsync(
        int hotelId,
        DateTime checkInDate,
        DateTime checkOutDate,
        int? excludeBookingId = null,
    ...
    public async Task<IEnumerable<DoAn.HotelParking.Core.Domain.Entities.Booking.Booking>> GetActiveBookingsByHotelAsync(
        int hotelId,
        DateTime fromDate,
        DateTime toDate,
        CancellationToken cancellationToken = default)
