    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Vui lòng chuyển đúng số tiền: ${NumberFormat.currency(locale: 'vi_VN', symbol: '₫').format(total)}',
  ...
  void _showSuccessDialog(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        key: const Key('booking_success_dialog'),
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Yêu cầu đặt phòng của bạn đã được ghi nhận. Khách sạn đang kiểm tra giao dịch và sẽ duyệt đơn.',
              textAlign: TextAlign.center,
              style: GoogleFonts.dmSans(
            ...
            SizedBox(
              ...
              height: 50,
              child: ElevatedButton(
                key: const Key('booking_success_ok_button'),
                onPressed: () {
